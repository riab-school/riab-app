    ...
    <body>
        ...
        <div class="intro-wrapper d-flex align-items-center justify-content-center text-center">
            <div class="container">
                ...
                <h2 style="color:aliceblue">Fitur ini sedang maintenance</h2>
                <h5 style="color:aliceblue">Silahkan kembali sesaat lagi</h5>
            </div>
        </div>
        <div class="get-started-btn">
            <a class="btn btn-warning btn-lg w-100" href="{{ url()->previous() }}">
