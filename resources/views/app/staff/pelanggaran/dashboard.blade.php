...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5>Top 10 Pelanggar Bulan Ini</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover table-sm table-borderless" id="dataTable" width="100%">
                        <tbody id="top_month_violation_data">
        ...
        function getData(chartYears){
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $('#week_violation_count').html(res.data.week_violation_count);
                    $('#day_violation_count').html(res.data.day_violation_count);
                    renderTable(res.data.top_violation_count, '#top_violation_data');
                    renderTable(res.data.top_month_violation, '#top_month_violation_data');
                    renderChartViolation(res.data.chart_violation);
                },
            ...
            data.forEach(function(item) {
                ...
                html += `
                    <tr>
                        ...
                        <td>
                            <h6 class="mb-1">${item.total} Pelanggaran</h6>
                        </td>
                    </tr>
                `;
            });
