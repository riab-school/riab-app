    ...
    <tbody>
        ...
        @foreach ($data as $item)
            <tr>
                ...
                <td>{{$item['user']->studentOriginDetail && $item['user']->studentOriginDetail->origin_head_recommendation !== NULL ? Storage::disk('s3')->url($item['user']->studentOriginDetail && $item['user']->studentOriginDetail->origin_head_recommendation) : 'Tidak Upload'}}</td>
                <td>{{$item['user']->studentOriginDetail && $item['user']->studentOriginDetail->rank_certificate !== NULL ? Storage::disk('s3')->url($item['user']->studentOriginDetail && $item['user']->studentOriginDetail->rank_certificate) : 'Tidak Upload'}}</td>
                <td>{{$item['user']->studentOriginDetail && $item['user']->studentOriginDetail->certificate_of_health !== NULL ? Storage::disk('s3')->url($item['user']->studentOriginDetail && $item['user']->studentOriginDetail->certificate_of_health) : 'Tidak Upload'}}</td>
                <td>{{$item['user']->studentOriginDetail && $item['user']->studentOriginDetail->letter_of_promise_to_financing !== NULL ? Storage::disk('s3')->url($item['user']->studentOriginDetail && $item['user']->studentOriginDetail->letter_of_promise_to_financing) : 'Tidak Upload'}}</td>
                <td>{{$item['user']->studentOriginDetail && $item['user']->studentOriginDetail->report_1_1 !== NULL ? Storage::disk('s3')->url($item['user']->studentOriginDetail && $item['user']->studentOriginDetail->report_1_1) : 'Tidak Upload'}}</td>
                <td>{{$item['user']->studentOriginDetail && $item['user']->studentOriginDetail->report_1_2 !== NULL ? Storage::disk('s3')->url($item['user']->studentOriginDetail && $item['user']->studentOriginDetail->report_1_2) : 'Tidak Upload'}}</td>
                <td>{{$item['user']->studentOriginDetail && $item['user']->studentOriginDetail->report_2_1 !== NULL ? Storage::disk('s3')->url($item['user']->studentOriginDetail && $item['user']->studentOriginDetail->report_2_1) : 'Tidak Upload'}}</td>
                <td>{{$item['user']->studentOriginDetail && $item['user']->studentOriginDetail->report_2_2 !== NULL ? Storage::disk('s3')->url($item['user']->studentOriginDetail && $item['user']->studentOriginDetail->report_2_2) : 'Tidak Upload'}}</td>
