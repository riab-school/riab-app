...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-header-right">
            <a href="{{ route('staff.master-psb.student-list.download') }}" class="btn btn-sm btn-primary">Download All</a>
        </div>
    </div>
    <div class="card-body">
            ...
            <table id="dataTable" class="table table-sm table-hover" style="width: 100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->psbHistory->studentCatRoom ? $item->psbHistory->studentCatRoom->room_name . " - " . $item->psbHistory->studentCatRoom->room_session : NULL }}</td>
                        ...
                        <td>{{ $item->psbHistory->parentInterviewRoom ? $item->psbHistory->parentInterviewRoom->room_name . " - " . $item->psbHistory->parentInterviewRoom->room_session : NULL }}</td>
                    </tr>
                    @empty
                    <tr>
