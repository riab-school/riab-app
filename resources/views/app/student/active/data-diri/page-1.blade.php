        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-danger" role="alert">
                    Data diri anda sudah lengkap, silahkan lanjut ke halaman berikutnya.
                </div>
                @endif
                <form action="{{ route('student.active.data-diri.store-page-1') }}" method="POST" onsubmit="return processData(this)">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <span class="text-muted small"><i>Anda tidak dapat mengubah foto profil. Hubungi admin atau pembina untuk bantuan lebih lanjut.</i></span>
                        </div>
                        <div class="col-md-9">
                            <div class="mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <span class="text-muted small">NIS tidak dapat diubah</span>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
