            ...
            <div class="card-body">
                @if($isCompleteParent)
                    <div class="alert alert-danger" role="alert">
                        Data orang tua Anda sudah lengkap, silahkan lanjut ke halaman berikutnya.
                    </div>
                @endif
                <form action="{{ route('student.active.data-diri.store-page-3') }}" method="POST" onsubmit="return processData(this)">
                    @csrf
                    @php
