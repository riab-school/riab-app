<div class="row mb-3">
    <div class="col-12">
        ...
        <ul class="nav flex-column nav-pills rounded" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <li>
                <a class="nav-link text-start @if(request()->page == '2') active @endif d-flex justify-content-between align-items-center" href="{{ route('student.active.data-diri', ['page' => 2]) }}">
            ...
            <li>
                <a class="nav-link text-start @if(request()->page == '3') active @endif d-flex justify-content-between align-items-center" href="{{ route('student.active.data-diri', ['page' => 3]) }}">
            ...
            <li>
                <a class="nav-link text-start @if(request()->page == '4') active @endif d-flex justify-content-between align-items-center" href="{{ route('student.active.data-diri', ['page' => 4]) }}">
                    <div>Data Wali</div>
            ...
            <li>
                <a class="nav-link text-start @if(request()->page == '5') active @endif d-flex justify-content-between align-items-center" href="{{ route('student.active.data-diri', ['page' => 5]) }}">
