            ...
            <div class="card-body">
                @if($health && $health->is_completed)
                    <div class="alert alert-danger" role="alert">
                        Data kesehatan Anda sudah lengkap, silahkan lanjut ke halaman berikutnya.
                    </div>
                @endif
                <form action="{{ route('student.active.data-diri.store-page-5') }}" method="POST" onsubmit="return processData(this)">
                    @csrf
