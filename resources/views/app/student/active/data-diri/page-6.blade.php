            ...
            <div class="card-body">
                @if($documents && $documents->is_completed)
                    <div class="alert alert-danger" role="alert">
                        Data dokumen dan berkas anda sudah lengkap, anda dapat mengajukan permohonan perbuhan data kepadas pembina atau admin.
                    </div>
                @endif
                <form id="form-berkas" action="{{ route('student.active.data-diri.store-page-6') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <h3>Pas Photo</h3>
                        <section>
