            ...
            <div class="card-body">
                @if($contact && $contact->is_completed)
                    <div class="alert alert-danger" role="alert">
                        Data wali Anda sudah lengkap, silahkan lanjut ke halaman berikutnya.
                    </div>
                @endif
                <form action="{{ route('student.active.data-diri.store-page-4') }}" method="POST" onsubmit="return processData(this)">
                    @csrf
