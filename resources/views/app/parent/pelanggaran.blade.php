...
@section('content')
    <div class="container">
        <div class="section-heading d-flex align-items-center justify-content-between rtl-flex-d-row-r">
            <h6>Total Catatan Pelanggaran
                <span id="totalCount"></span>
            </h6>
        </div>
        <div class="row g-2" id="renderRiwayatPelanggaran">
...
<script>
    ...
    function loadRiwayat() {
        ...
        isLoading = true;
        $.ajax({
            url: "{{ route('parent.pelanggaran.history') }}",
            type: "GET",
            data: { page: page },
            dataType: "json",
            success: function(res) {
                ...
                if (res.data.length === 0) {
                    ...
                    $('#renderRiwayatPelanggaran').append(html);
                }
                            ...
                            <div class="horizontal-product-card">
                                <div class="d-flex align-items-center">
                                    <div class="product-thumbnail-side">
                                        ...
                                        ` : `
                                            <a class="product-thumbnail shadow-sm d-block" href="javascript:void(0);">
                                                <img src="{{ asset('mobile-assets/img/icons/violation.png') }}" alt="icon_perizinan" class="img-fluid w-80">
                                            </a>
                                        `}
                                    </div>
                                    <div class="product-description">
                                        ...
                                        <div class="d-flex flex-column gap-1">
                                            ...
                                            <div class="product-rating">
                                                <i class="fa-solid fa-star"></i><b>Di Proses Oleh :</b>&nbsp;${item.process_by.staff_detail.name}
                                            </div>
                                            <div class="product-rating">
