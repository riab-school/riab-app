...
class StudentStatusController extends Controller
{
    ...
    public function dataTableNaikKelasFrom(Request $request)
    {
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->editColumn('address', function ($row) {
                    return $row->studentDetail ? getProvince($row->studentDetail->province_id). ", ".getCity($row->studentDetail->city_id): '-';
                })
                ->make(true);
        }
    }
